...
class Map_Obj():
    ...
    def paint_box(self, paint_box: list[int, int],
                                themap: Union[np.ndarray, str]):
        themap[paint_box[0]][paint_box[1]] = ' F '

    def paint_box_finished(self, paint_box: list[int, int],
                                themap: Union[np.ndarray, str]):
        themap[paint_box[0]][paint_box[1]] = ' D '
